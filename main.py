...
def main():
    ...
    parser.add_argument('--weight-decay', type=float, default=0.00000001,
    ...
    if not args.test:
        ...
        for epoch in range(start_epoch,args.epochs):
            ...
            steps,best_loss = training.train(args,model,criterion,device,train_loader,test_loader,train_loss_loader,optimizer,epoch,writer,normalize_factor,steps,best_loss)
    else:
        #검증용
        print("activate test code!!!!")
        args.random_length[0] = False
        test_mse, test_mae, test_won_sum_mae, test_won_mae,test_mae_list,test_var= training.eval(args,test_loader,model,criterion,device,normalize_factor,teacher_forcing=False)
